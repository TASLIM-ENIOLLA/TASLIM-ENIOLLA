                            ...
                            <div className = 'row'>
                                ...
                                <div className = 'col-md-8 mb-4 fo-s-15 text-muted'>
                                    <div className = ''>
                                        ...
                                        <p>
                                            Today, I have been opportuned to work with various developers on different project ranging from build frontend design to developing fullstack applications.
                                        </p>
                                        <p>
                                ...
                                <div className = 'col-md-4 mb-4'>
                                    <img className = 'd-block w-100 rounded-lg image' src = './images/team-2.jpg' />
                                </div>
                            </div>
                        </div>
                    </div>
